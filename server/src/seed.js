  ...
  const articles = [
    {
      ...
      ar: {
        ...
        content: "<p>في مباراة حسمها الانضباط التكتيكي أكثر من الاستعراض، قدم نهائي دوري أبطال أوروبا درساً في الإدارة الحديثة.</p>",
        slug: "nahaie-dawri-al-abtal",
        seoTitle: "تحليل نهائي دوري الأبطال | دلتا نيوز",
      },
      category: "football",
      author: editor,
      cover: "https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=1200&h=675&q=80",
    ...
    },
    {
      en: {
        ...
        content: "<p>The race for advanced AI accelerators has entered a new phase.</p>",
      ...
      ar: {
        ...
        content: "<p>دخل سباق مسرّعات الذكاء الاصطناعي المتقدمة مرحلة جديدة.</p>",
        slug: "sibaq-raqaeq-al-thaka",
      },
      category: "technology",
      author: writer,
      cover: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&h=675&q=80",
    ...
    },
    {
      en: {
        ...
        content: "<p>Major central banks struck a carefully balanced tone this week.</p>",
        slug: "central-banks-patience-inflation-cools",
      },
      ar: {
        title: "البنوك المركزية تشير إلى الصبر مع تراجع التضخم أسرع من المتوقع",
        excerpt: "الأسواق ترتفع مع إشارات تيسيرية.",
        content: "<p>اتخذت البنوك المركزية الكبرى نبرة متوازنة هذا الأسبوع.</p>",
        slug: "al-bunuk-al-markazia-wal-tadakhum",
      },
      category: "business",
      author: writer,
      cover: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: { featured: true },
      views: 8920,
    ...
    },
    {
      ...
      ar: {
        ...
        content: "<p>مع بقاء عدد قليل من فعاليات التأهل الأولمبي، تتعامل الاتحادات مع كل منافسة كأنها نهائي.</p>",
        slug: "sibaq-al-taahol-al-olompi",
      },
      category: "sports",
      author: editor,
      cover: "https://images.unsplash.com/photo-1517649763962-0c623066027e?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: { trending: true },
      views: 6540,
    ...
    },
    {
      ...
      category: "football",
      author: editor,
      cover: "https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: { trending: true },
      views: 11200,
    ...
    },
    {
      en: {
        ...
        content: "<p>Venture activity across Cairo’s tech corridor accelerated in the first half of the year.</p>",
        slug: "cairo-tech-corridor-venture-funding",
      },
      ar: {
        title: "ممر القاهرة التقني يجذب تمويلاً استثمارياً قياسياً في النصف الأول",
        excerpt: "شركات مصرية ناشئة تجمع رأس مال أكبر.",
        content: "<p>تسارع نشاط رأس المال المغامر في ممر التقنية بالقاهرة.</p>",
        slug: "tamwil-sharikat-al-qahira",
      },
      category: "technology",
      author: writer,
      cover: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: { featured: true },
      views: 7340,
    ...
    },
    {
      en: {
        ...
        content: "<p>Governments across North Africa advanced export-oriented energy agreements this month.</p>",
        slug: "north-africa-energy-export-routes",
      },
      ar: {
        title: "صفقات طاقة في شمال أفريقيا ترسم مسارات تصدير جديدة لأوروبا",
        excerpt: "محادثات خطوط الأنابيب والهيدروجين الأخضر تعيد رسم الخريطة.",
        content: "<p>تقدّمت حكومات في شمال أفريقيا بعدة اتفاقيات طاقة موجّهة للتصدير.</p>",
        slug: "taqa-shamal-afriqya",
      },
      category: "business",
      author: writer,
      cover: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: { trending: true },
      views: 5680,
    ...
    },
    {
      en: {
        ...
        excerpt: "Leaders push coordinated investment after a season of extreme heat.</p>",
        content: "<p>A regional summit closed with commitments to share climate data and accelerate water projects.</p>",
        slug: "regional-summit-climate-water-security",
      },
      ar: {
        title: "قمة إقليمية تركز على المرونة المناخية وأمن المياه",
        excerpt: "القادة يدفعون باستثمار منسّق بعد موسم حر شديد.",
        content: "<p>اختُتمت قمة إقليمية بالتزامات لتبادل بيانات المناخ.</p>",
        slug: "qimma-manakhiya-wa-miyah",
      },
      category: "news",
      author: editor,
      cover: "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?auto=format&fit=crop&w=1200&h=675&q=80",
    ...
    },
    {
      en: {
        ...
        content: "<p>Opening weekend crowds set a new attendance benchmark.</p>",
        slug: "womens-basketball-record-attendance",
      },
      ar: {
        title: "دوري كرة السلة للسيدات يحقق حضوراً قياسياً في افتتاح الموسم",
        excerpt: "قاعات ممتلئة تمثّل نقطة تحول للعبة الاحترافية.",
        content: "<p>سجّلت جماهير عطلة الافتتاح معيار حضور جديداً.</p>",
        slug: "douri-salla-sayidat",
      },
      category: "sports",
      author: editor,
      cover: "https://images.unsplash.com/photo-1546519638-68e109498ffc?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: { trending: true },
      views: 4820,
    ...
    },
    {
      en: {
        ...
        excerpt: "CIOs balance cost, control and compliance as alternatives mature.",
        content: "<p>Enterprise buyers are rewriting AI roadmaps around hybrid stacks.</p>",
      ...
      ar: {
        ...
        content: "<p>يعيد مشترو المؤسسات كتابة خرائط طريق الذكاء الاصطناعي.</p>",
        slug: "namazij-maftuha-lil-muassasat",
      },
      category: "technology",
      author: writer,
      cover: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: {},
      views: 6100,
    ...
    },
    {
      en: {
        ...
        content: "<p>Container rates declined for a third consecutive week.</p>",
        slug: "shipping-costs-asia-mediterranean",
      },
      ar: {
        title: "تكاليف الشحن تنخفض على خطوط آسيا–المتوسط الرئيسية",
        excerpt: "مؤشرات الشحن تهدأ مع عودة السعة.",
        content: "<p>انخفضت أسعار الحاويات للأسبوع الثالث على التوالي.</p>",
        slug: "takaleef-al-shahn-al-mutawassit",
      },
      category: "business",
      author: writer,
      cover: "https://images.unsplash.com/photo-1494412519320-aa613dfb7738?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: {},
      views: 3950,
    ...
    },
    {
      en: {
        ...
        content: "<p>Organizers unveiled a denser autumn calendar of festivals across North African capitals.</p>",
      ...
      ar: {
        ...
        content: "<p>كشف المنظّمون عن روزنامة خريف أكثر كثافة للمهرجانات.</p>",
        slug: "mahrajanat-thaqafiya",
      },
      category: "news",
      author: editor,
      cover: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?auto=format&fit=crop&w=1200&h=675&q=80",
      flags: { featured: true },
      views: 5210,
